...
In this section, we provide an overview of the proof that theorem \ref{theorem:separation-linear-final} implies expressive completeness. %TODO: Finish this proof / remove this section. At the very least, I want to describe the general separation theorem.
